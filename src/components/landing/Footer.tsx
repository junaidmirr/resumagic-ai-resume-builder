    ...
    <footer className="border-t border-app-border bg-app-surface py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm text-app-text-secondary leading-relaxed mb-6">
              The intelligent productivity platform for modern professionals.
              Build resumes, cover letters, and PDFs that stand out.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-8 h-8 rounded-full border border-app-border flex items-center justify-center text-app-text-muted hover:text-brand-primary hover:border-brand-primary transition-colors"
              >
                <Globe className="w-4 h-4" />
              </a>
              <a
                href="mailto:support@worklabs.studio"
                className="w-8 h-8 rounded-full border border-app-border flex items-center justify-center text-app-text-muted hover:text-brand-primary hover:border-brand-primary transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  to="/build"
                  className="text-sm text-app-text-secondary hover:text-brand-primary transition-colors"
                >
                  AI Resume Writer
                </Link>
              </li>
        ...
        <div className="pt-8 border-t border-app-border flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-app-text-muted">
            Standard-compliant vector resume engine.
          </p>
        </div>
      </div>
    </footer>
