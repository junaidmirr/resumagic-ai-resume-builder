      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-brand-primary/10 via-app-bg to-app-bg text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg md:text-xl text-app-text-secondary max-w-3xl mx-auto leading-relaxed">
            Resumagic was created to replace broken Word templates and clunky
            PDF tools with high-performance vector rendering, smart AI content
            generation, and ATS-optimized visual designs.
          </p>
        </div>
      </section>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-1">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-sm text-app-text-secondary leading-relaxed mb-4">
              Traditional resume builders output low-quality print layouts or
              broken formatting that gets rejected by Applicant Tracking Systems
              before a recruiter ever reads it.
            </p>
            <p className="text-sm text-app-text-secondary leading-relaxed mb-6">
              We built Resumagic from the ground up leveraging generative AI
              models, high-resolution vector PDF rendering, and instant document
              text extraction.
            </p>
          ...
          <div className="glass-card rounded-3xl p-8 border border-app-border relative overflow-hidden bg-gradient-to-br from-brand-primary/5 via-app-surface to-brand-accent/5">
            ...
            <h3 className="text-xl font-bold mb-4">
              Product Innovation Meets Human Career Coaching
            </h3>
            <p className="text-xs text-app-text-secondary leading-relaxed mb-4">
              Our platform combines intuitive visual design controls, fast
              document processing, and cloud database sync to make resume
              creation enjoyable and effective.
            </p>
            <div className="p-4 rounded-2xl bg-app-bg border border-app-border flex items-center gap-3">
              ...
              <div className="text-xs">
                ...
                <span className="text-app-text-muted">
                  Smart career content and design synthesis
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-app-surface border border-app-border">
              ...
              <p className="text-xs text-app-text-secondary leading-relaxed">
                Instant PDF imports, fast canvas element updates, and rapid
                vector rendering.
              </p>
            </div>
            <div className="p-8 rounded-3xl bg-app-surface border border-app-border">
              ...
              <p className="text-xs text-app-text-secondary leading-relaxed">
                Your data is protected by Firebase authentication and encrypted
                database storage.
              </p>
            </div>
            <div className="p-8 rounded-3xl bg-app-surface border border-app-border">
              ...
              <h3 className="font-bold text-lg mb-2">
                ATS Guaranteed Compliance
              </h3>
              <p className="text-xs text-app-text-secondary leading-relaxed">
                Vector PDFs pass Workday, Taleo, Greenhouse, and Lever parsers
                flawlessly.
              </p>
            </div>
          </div>
        ...
        <div className="text-center glass-card rounded-3xl p-10 border border-brand-primary/20 bg-gradient-to-r from-brand-primary/10 via-app-surface to-brand-accent/10">
          ...
          <p className="text-sm text-app-text-secondary max-w-xl mx-auto mb-8">
            Join thousands of professionals landing interviews at top technology
            companies and Fortune 500s.
          </p>
          <Link
            to="/build"
