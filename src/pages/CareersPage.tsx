...
const JOBS: JobOpening[] = [
  {
    ...
    type: "Full-Time",
    description:
      "Lead frontend canvas state architecture and high-speed PDF export rendering pipelines.",
  },
  {
    id: "job-2",
    ...
    type: "Full-Time",
    description:
      "Design structured AI prompt workflows, ATS keyword optimization models, and resume content generators.",
  },
  {
    id: "job-3",
    ...
    type: "Full-Time",
    description:
      "Optimize vector canvas rendering primitives, layout positioning algorithms, and document export performance.",
  },
  {
    id: "job-4",
    ...
    type: "Full-Time",
    description:
      "Drive viral referral loops, template conversion optimization, and SEO content engine strategy.",
  },
];
      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-brand-primary/10 via-app-bg to-app-bg text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg md:text-xl text-app-text-secondary max-w-3xl mx-auto leading-relaxed">
            We are a remote-first team of engineers, designers, and AI
            researchers building the world's most advanced resume platform.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="p-6 rounded-2xl bg-app-surface border border-app-border">
            ...
            <p className="text-xs text-app-text-secondary leading-relaxed">
              Competitive salary, meaningful equity, 401(k) matching, and full
              health coverage.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-app-surface border border-app-border">
            ...
            <p className="text-xs text-app-text-secondary leading-relaxed">
              $3,000 home office budget + $2,000 annual budget for books,
          ...
          {JOBS.map((job) => (
            ...
            >
              ...
              <button
                ...
                className="px-6 py-3 rounded-xl font-bold bg-slate-900 hover:bg-slate-800 text-white dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 transition-colors text-sm whitespace-nowrap shadow-md shrink-0 flex items-center gap-2 cursor-pointer"
              >
          ...
          <div className="bg-app-surface border border-app-border rounded-3xl p-8 max-w-lg w-full relative shadow-2xl">
            ...
            {applied ? (
              <div className="py-12 text-center">
                ...
                <p className="text-xs text-app-text-secondary">
                  Our recruiting team will reach out to you shortly.
                </p>
              </div>
            ) : (
              <form onSubmit={handleApply} className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2.5 rounded-xl bg-app-bg border border-app-border text-sm"
                    required
                  />
                </div>
                <div>
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-xl font-bold bg-slate-900 hover:bg-slate-800 text-white dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 transition-colors text-sm shadow-md mt-4 cursor-pointer"
                >
                  Submit Application
                </button>
              </form>
