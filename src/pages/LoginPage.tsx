    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-app-bg">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-brand-primary overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 w-full max-w-lg">
          <Link
            to="/"
            className="inline-flex items-center gap-3 mb-16 hover:opacity-80 transition-opacity"
          >
            <img
              src="/favicon.svg"
              alt="Resumagic"
          ...
          >
            ...
            <p className="text-lg text-white/80 leading-relaxed mb-12">
              ...
              Resumagic's intelligent, beautiful resume builder.
            </p>
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-3">
                ...
                <div className="w-10 h-10 rounded-full border-2 border-brand-primary bg-slate-500 flex items-center justify-center text-xs font-bold text-white">
                  +2k
                </div>
              </div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          >
            ...
            <p className="mt-8 text-center text-xs text-app-text-muted">
              ...
              <Link
                to="/terms"
                className="text-app-text hover:underline hover:text-brand-primary transition-colors"
              >
                Terms of Service
              </Link>{" "}
              and{" "}
