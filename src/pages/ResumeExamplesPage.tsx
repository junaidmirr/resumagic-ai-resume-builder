    ...
    <div className="min-h-screen bg-app-bg text-app-text flex flex-col font-sans transition-colors duration-200">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-brand-primary/10 via-app-bg to-app-bg text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg md:text-xl text-app-text-secondary max-w-3xl mx-auto leading-relaxed mb-8">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredExamples.map((ex) => (
            <div
              key={ex.id}
              className="bg-app-surface rounded-3xl overflow-hidden border border-app-border hover:border-brand-primary/50 transition-all hover:shadow-xl group flex flex-col justify-between"
            >
              <div>
                <div className="relative h-72 bg-slate-950 overflow-hidden border-b border-app-border p-4 flex items-center justify-center">
                  <img
                    src={ex.thumbnailUrl}
                    alt={ex.title}
                  ...
                  />
                  <div className="absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-black bg-teal-500 text-white shadow-md flex items-center gap-1 z-10">
                ...
                <div className="p-6">
                  <span className="text-xs font-bold text-brand-primary block mb-2">{ex.industry}</span>
                  <h3 className="text-lg font-bold mb-3 leading-snug group-hover:text-brand-primary transition-colors">
                    {ex.title}
                  </h3>
              ...
              <div className="p-6 pt-0">
                <button
                  ...
                  className="w-full py-3 rounded-xl font-bold bg-brand-primary text-white hover:bg-brand-primary-hover transition-colors text-sm flex items-center justify-center gap-2 shadow-lg shadow-brand-primary/20"
                >
